...
import { Chart, Fetcher, intervalsMs, Player, indicator } from '@dmidz/tickschart';
...
const chart = new Chart( document.getElementById('chart'), timeScaleMs, defaultTick, ( index: number ) => {
